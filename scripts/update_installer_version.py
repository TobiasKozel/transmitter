...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Transmitter Demo Installer\n"
      else:
        line="OutputBaseFilename=Transmitter Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Transmitter Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Transmitter installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Transmitter Demo installer\n"
     else:
       line="SetupWindowTitle=Transmitter installer\n"
