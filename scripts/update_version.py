...
def main():
  ...
  plistpath = scriptpath + "/resources/Transmitter-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transmitter-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transmitter-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transmitter-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Transmitter-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Transmitter.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Transmitter.iss",inplace=1):
